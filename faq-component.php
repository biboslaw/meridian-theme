...
<section class="md:w-full w-[92%] mx-auto">
    <div class="container max-w-[840px] pt-[72px] mx-auto faq-container">
        <h1 class="text-[50px] font-black uppercase text-center text-gray-text mb-10">
        ...
        if ( $the_query_without_term->have_posts() ) {
          ...
          <div class="rounded-4xl shadow-video-box faq-item overflow-hidden">
            <button class="group flex items-center justify-between w-full p-6">
              <h3 class="group-hover:text-blue font-semibold text-gray-text text-left text-xl">
        ...
        foreach( $terms as $term ) {
          ...
          if ( $the_query->have_posts() ) {
            ...
            <div class="rounded-4xl shadow-video-box faq-item">
              <button class="group flex items-center justify-between w-full p-6 ">
                <h3 class="group-hover:text-blue font-semibold text-gray-text text-left text-xl">
                  <?= get_field( 'question' ) ? __(  get_field( 'question' ), 'meridian' ) : ''; ?>
                </h3>
              ...
              <p class="text-left">
                <?= get_field( 'answer' ) ? __(  get_field( 'answer' ), 'meridian' ) : ''; ?>
              </p>
            </div>
    ...
    <div class="max-w-[1200px] w-full mx-auto bg-orange rounded-5 shadow-little-box py-10 flex flex-col items-center mt-[165px] mb-[120px]">
      <h3 class="text-white text-2xl font-black mb-16">
